...
body {
    ...
    background: #fff url("@/static/imgs/texture.jpeg") repeat 0 0;
    color: #fff;
}
...
.wrapper {
    ...
    background: transparent url("@/static/imgs/wood-fence.png") no-repeat center top 24em;
}
...
.box {
    ...
    padding: 1em 1em;
    text-align: center;
    background: transparent url("@/static/imgs/dogs.jpeg") no-repeat top 10em center;
}
